import {Home as HomeIcon, Search, Library, ChevronLeft, ChevronRight, PlusSquare, Star, Play } from 'lucide-react'
      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 p-6">
          ...
          <div className='grid grid-cols-3'>
            ...
            <a href="#" className="bg-white/10 group rounded flex items-center gap-4 overflow-hidden hover:bg-white/20 transition-colors">
              <img src="https://cdns-images.dzcdn.net/images/cover/490b898131c795f1f8d2954ed6f267a7/120x120-000000-80-0-0.jpg"
